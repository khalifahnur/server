...
const GenerateSecretKeyUser_1 = __importDefault(require("./GenerateSecretKeyUser"));
...
if (!secretKey) {
    secretKey = (0, GenerateSecretKeyUser_1.default)();
    console.log("Generated Secret Key:", secretKey);
    // Check if the .env file exists and is accessible
    if (!fs_1.default.existsSync(envPath)) {
        // If .env file doesn't exist, create it
        try {
            fs_1.default.writeFileSync(envPath, `JWT_SECRET_KEY_USER=${secretKey}\n`);
        ...
        try {
            ...
            if (!envFileContent.includes('JWT_SECRET_KEY_USER=')) {
                fs_1.default.appendFileSync(envPath, `JWT_SECRET_KEY_USER=${secretKey}\n`);
...
//# sourceMappingURL=SecretKeyConfigUser.js.map