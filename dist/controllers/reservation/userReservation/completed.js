...
const userCompletedReservation = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        console.error("Error retrieving completed reservation:", error);
        res
            .status(500)
            .json({
            error: "An error occurred while retrieving completed reservation",
        });
    }
});
module.exports = userCompletedReservation;
