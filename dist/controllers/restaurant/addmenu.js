...
const addMenu = async (req, res) => {
    ...
    const uploadedImageUrl = await (0, UploadImage_1.uploadMenuToCloudinary)(req.file);
    ...
    try {
        ...
        const updatedRestaurant = await Restaurant.findByIdAndUpdate(restaurantId, { $push: { [updatePath]: newMenuItem } }, { new: true });
